    ...
    <main className="min-h-screen px-4 py-12">
      <article className="mx-auto max-w-2xl text-ink-muted">
        ...
        <p className="mt-2 leading-relaxed">
          ...
          hostname, TLD, category scores, and issue counts. We use this to power live benchmarks on
          SEOScan and may license or sell <em>aggregated market insights</em> derived from
          public-website scans. This is not personal profile data.
        </p>
