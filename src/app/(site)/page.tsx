      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        <SeoPageIntro heading="What SEOHub checks on every scan">
          ...
          <p>
            ...
            to see the full deliverable before you scan. SEOHub stays browser-first so you can
            re-check a site whenever you ship changes, without buying another seat.
          </p>
        </SeoPageIntro>
        <HomeFeatures />
      </div>
